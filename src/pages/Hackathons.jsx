  ...
  return (
    <div style={styles.container}>
        ...
        <div style={styles.modalOverlay}>
          <div style={styles.modalContent}>
            ...
            <div style={styles.modalHeader}>
              ...
              <h2 style={styles.modalTitle}>Welcome to the Hackathon Arena! ⚡</h2>
            </div>
            <div style={styles.motivationalBox}>
              <p style={styles.motivationalText}>
                Ready to Code? Let's Create Magic! 🧙‍♂️
              </p>
              <p style={styles.motivationalMessage}>
                "Hackathons aren't just competitions - they're playgrounds for innovation! Bring your ideas, team up with brilliant minds, and build the future. 
                Win prizes, gain experience, and have a blast coding non-stop. Your next big project starts here! 🚀✨"
              </p>
              ...
              <div style={styles.tipsBox}>
                <p style={styles.tipTitle}>✨ Hackathon Pro Tips:</p>
                <ul style={styles.tipsList}>
                  <li>✓ Form a team of 3-4 diverse members</li>
                  <li>✓ Start with a unique problem statement</li>
                  <li>✓ Build, present, and WIN! 🎯</li>
                </ul>
              </div>
            </div>
            <button
      ...
      <div style={styles.header}>
        <h1 style={styles.title}>🏆 Hackathons for Students</h1>
      ...
      <div style={styles.grid}>
        {filteredHackathons.length > 0 ? (
          filteredHackathons.map((hackathon) => (
            <div key={hackathon.id} style={styles.card} data-animate>
