export default function CyberSecurity({ setCurrentPage }) {
  return (
    <div style={styles.container}>
      ...
      <section style={styles.mainSection}>
        <div style={styles.content}>
          <h2 style={styles.title}>🔐 Cyber Security</h2>
          <p style={styles.subtitle}>
            Learn cybersecurity fundamentals, ethical hacking, and secure coding practices
          </p>

          <div style={styles.card}>
            <h3 style={styles.cardTitle}>Coming Soon 🚀</h3>
            <p style={styles.cardDescription}>
              This section is under development. Stay tuned for amazing cybersecurity courses and resources!
            </p>
          </div>
        </div>
      </section>
