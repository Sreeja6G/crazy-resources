        ...
        <div style={styles.modalOverlay}>
          <div style={styles.modalContent}>
            ...
            <div style={styles.modalHeader}>
              ...
              <h2 style={styles.modalTitle}>Your Internship Journey Starts Here! 🎯</h2>
            </div>
            <div style={styles.motivationalBox}>
              ...
              <div style={styles.tipsBox}>
                <p style={styles.tipTitle}>✨ Pro Tips for Landing Your Internship:</p>
                <ul style={styles.tipsList}>
                  <li>✓ Build a strong GitHub portfolio</li>
                  <li>✓ Practice coding problems daily</li>
                  <li>✓ Polish your resume with projects</li>
                </ul>
              </div>
            </div>
            <button
