    ...
    <section style={styles.section}>
      ...
      <div style={styles.cards}>
        ...
        <div style={styles.card} data-animate>
          ...
          <a 
            href="https://www.instagram.com/sybrai_sai?igsh=MXhjcXlzMXhxd2JxZg==" 
            target="_blank" 
            rel="noopener noreferrer"
            style={styles.instagramLink}
          >
      ...
      <div style={styles.memesSection}>
        <h2 style={styles.memesTitle}>Founder Memes 😂</h2>
...
const styles = {
  ...
  photoContainer: {
    ...
    overflow: "hidden",
    margin: "0 auto 20px",
    boxShadow: "0 20px 60px rgba(6, 182, 212, 0.4), inset 0 0 30px rgba(6, 182, 212, 0.15), 0 0 40px rgba(6, 182, 212, 0.2)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
